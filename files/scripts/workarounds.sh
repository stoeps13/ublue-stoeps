...
dnf install ./kernel-${KERNELVERSION}.x86_64.rpm ./kernel-core-${KERNELVERSION}.x86_64.rpm ./kernel-modules-${KERNELVERSION}.x86_64.rpm ./kernel-modules-core-${KERNELVERSION}.x86_64.rpm ./kernel-modules-extra-${KERNELVERSION}.x86_64.rpm
rm -rf kernel*.rpm
